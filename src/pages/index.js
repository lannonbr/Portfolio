...
const IndexPage = ({ data }) => (
  <section className="md:grid md:grid-cols-2 md:gap-8 mb-4">
    ...
    <div className="hidden md:block">
      <IllustrationImg src={office} alt="Person sitting on desk illustration" />
    </div> */}
  </section>
)
